...
const Reviews = () => {
    ...
    return (
        <div className="mt-24 mb-8 border-t border-gray-100 pt-8">
            <h2 className="text-[28px] font-bold text-[#002D58] font-['Cormorant_Garamond'] uppercase tracking-wider mb-12">
                Phản hồi của khách hàng
            </h2>

            <div className="flex flex-col gap-14 max-w-[1100px] text-black px-12">
