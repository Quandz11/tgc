        ...
        <div className="bg-white">
            ...
            <section className="max-w-[1240px] mx-auto py-16 md:py-32 px-6 md:px-12">
                ...
                <div className="max-w-[900px] text-[#212529] font-['Quicksand'] text-[18px] md:text-[25px] leading-[1.35] font-medium">
                    <p>
                        <span className="font-bold">TGC</span> được hình thành từ một triết lý đơn giản nhưng khác biệt:

                        Áo sơ mi không cần cà vạt nhưng vẫn chỉn chu, sang trọng, với cổ áo phom dựng và không quăn.
                        Cổ áo Tgc được thiết kế với cấu trúc định hình thông minh, tạo nên vẻ ngoài luôn có phom dáng đẹp trong suốt thời gian sử dụng. Sự sang trọng không còn là yếu tố hình thức, mà trở thành trạng thái tự nhiên của trang phục.
                        Bên cạnh việc sản xuất áo sơ mi có cổ sáng chế mang thương hiệu TgC, chúng tôi còn cung cấp phụ kiện cổ áo sáng chế cho các thương hiệu thời trang và đơn vị may mặc, góp phần hình thành một chuẩn mực mới cho áo sơ mi.
                    </p>
                </div>
            </section>
                ...
                <div className="grid md:grid-cols-2 gap-20 items-start">
                    ...
                    <div className="space-y-12">
                        <div>
                            ...
                            <p className="font-['Quicksand'] text-[15px] leading-relaxed text-[#555]">
                                TgC hướng tới việc định nghĩa lại chuẩn mực cổ áo sơ mi, nơi sự sang trọng đến từ kết cấu thông minh và tư duy thiết kế.

                                Chúng tôi tin rằng: Phong cách sang trọng bắt đầu từ những chi tiết nhỏ nhất và cổ áo là điểm khởi đầu.                    </p>
                        </div>
                    ...
                    <div className="space-y-12">
                        ...
                        <div>
                            ...
                            <p className="font-['Quicksand'] text-[15px] leading-relaxed text-[#555]">
                                TgC mang đến những chiếc áo sơ mi với thiết kế đột phá và chất lượng vượt trội, giúp phái mạnh thể hiện phong thái tự tin và đẳng cấp trong công việc và cuộc sống. Chúng tôi không chỉ bán sản phẩm, chúng tôi trao tặng sự hoàn hảo và tôn vinh giá trị của sự chỉn chu.                            </p>
                            <p className="mt-4 font-['Quicksand'] text-[15px] leading-relaxed text-[#555]">
                                Bên cạnh đó chúng tôi cam kết sẽ mang đến những giải pháp cho ngành may mặc với những chi tiết nhỏ nhưng lại tạo nên sự chỉn chu cho từng vóc dáng của bạn.                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-12 md:py-24 max-w-[1240px] mx-auto px-6">
                ...
                <div className="grid md:grid-cols-2 gap-8 md:gap-12 mb-8 items-center">
                    ...
                    <div className="space-y-8 font-['Quicksand']">
                        <p className="text-[17px] leading-relaxed text-[#333]">
                            Cổ áo sáng chế TgC – tuyệt tác thiết kế độc quyền trên thế giới, định hình chuẩn mực mới cho phong thái quý ông hiện đại. </p>
                        <p className="text-[17px] leading-relaxed text-[#333]">
                            Áo sơ mi không cần cà vạt nhưng vẫn chỉn chu sang trọng với cổ áo phom dựng và không quăn.                        </p>
                ...
                <div className="text-center max-w-[900px] mx-auto mb-20">
                    <p className="font-['Quicksand'] text-[17px] leading-relaxed text-[#333]">
                        Cổ áo sơ mi khi mặc với vest hai đầu lá cổ khép lại gần nhau
                    </p>
                </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="text-center max-w-[900px] mx-auto mb-20">
                        <p className="font-['Quicksand'] text-[17px] leading-relaxed text-[#333]">
                            Sơ mi cổ form dựng hoàn hảo, không quăn, luôn giữ vẻ ngay ngắn và chỉn chu. Hai lá cổ phẳng phiu, cân đối, duy trì khoảng cách ổn định khi mặc sơ mi đơn thuần, mang lại phong thái lịch lãm và tinh tế trong mọi khoảnh khắc.
                        </p>
                    </div>
